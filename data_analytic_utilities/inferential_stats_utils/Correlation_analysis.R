...
cor.test(correlation_data$var_1,correlation_data$var_2,method=c("pearson"))

# Spearman correlation coefficient (used when data are normal)
cor.test(correlation_data$var_1,correlation_data$var_2,method=c("spearman"))
...
mult_correlation<-Hmisc::rcorr(as.matrix(correlation_data),type=c('pearson'))
